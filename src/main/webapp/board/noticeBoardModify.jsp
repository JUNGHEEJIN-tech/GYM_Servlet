...
<body>
	...
	<div class="sub_contents">
		<h1 class="page_title">공지사항 글수정</h1>		
		<div class="page">
			<section id="bo_w">    			
    			<!-- 게시물 작성/수정 시작 { -->
    			<form name="noticeBoardModifyResult" id="fwrite" action="${conPath}/board/noticeBoardModifyResult" onsubmit="return fwrite_submit(this);" method="post" autocomplete="off" style="width:100%">
