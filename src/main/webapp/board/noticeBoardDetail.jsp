...
<link rel="stylesheet"
	href="${conPath }/resources/css/font-awesome.min.css">
	...
	<div class="sub_contents">
		...
		<div class="page">
			...
			<article id="bo_v" style="width: 100%">
				<header>
					<h2 id="bo_v_title">
						<span class="bo_v_tit"> ${freeBoardDetail.title } </span>
					</h2>
				</header>
				<section id="bo_v_info">
					...
					<div class="profile_info">
						<div class="profile_info_ct">
							...
							<strong> 댓글 0건 </strong> <strong>조회수
								${freeBoardDetail.views }회</strong> <strong class="if_date">${freeBoardDetail.regist_date }</strong>
						</div>
					</div>
					...
					<div id="bo_v_top">
						<ul class="btn_bo_user bo_v_com">
							<li><a href="${conPath }/board/freeBoardList"
								class="btn_b01 btn"> 목록</a></li>
							<c:if test="${not empty loginMember }">
								<li><a href="${conPath }/board/freeBoardWrite"
									class="btn_b02 btn"> 글쓰기 </a></li>
								<li><a
									href="${conPath }/board/freeBoardDelete?idx=${freeBoardDetail.idx}"
									class="btn_b02 btn"> 글삭제 </a></li>
							</c:if>
							<c:if
								test="${not empty loginMember and loginMember.idx eq freeBoardDetail.member.idx }">
								<a
									href="${conPath }/board/freeBoardModify?idx=${freeBoardDetail.idx}"
									class="btn_b02 btn"> 글수정 </a>
							</c:if>
						</ul>
