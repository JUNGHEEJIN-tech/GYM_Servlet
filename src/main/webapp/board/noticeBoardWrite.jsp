...
<body>
    <div class="sub_contents">
        <h1 class="page_title">공지사항 글쓰기</h1>        
        <div class="page">
            <section id="bo_w">
                <h2 class="sound_only">공지사항 글쓰기</h2>
                <!-- 게시물 작성/수정 시작 { -->
                <form name="noticeBoardWriteResult" id="fwrite" action="${conPath }/board/noticeBoardWriteResult" onsubmit="return fwrite_submit(this);" method="get" enctype="multipart/form-data" autocomplete="off" style="width:100%">
                    ...
                    <div class="btn_confirm write_div">
                        <a href="${conPath }/board/noticeBoardList" class="btn_cancel btn">취소</a>
