...
-- 자유게시판 댓글 더미데이터 생성 (20개)

INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('정말 좋은 글이에요!', 1, 61);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('많은 도움이 되었습니다. 감사합니다.', 2, 62);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('궁금한 점이 해결되었네요!', 3, 63);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('잘 읽었습니다. 유익해요.', 4, 64);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('이 내용 정말 좋네요!', 5, 65);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('공감가는 글입니다. 감사합니다.', 6, 66);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('내용이 정말 흥미롭네요!', 7, 67);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('잘 정리해주셨네요. 도움됐습니다.', 8, 68);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('정보 공유해주셔서 감사해요!', 9, 69);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('좋은 정보 감사합니다.', 10, 70);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('유익한 글이네요!', 1, 61);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('많이 배워갑니다. 수고하셨어요.', 2, 62);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('참고자료로 사용하겠습니다.', 3, 63);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('글을 읽고 많이 배웠습니다.', 4, 64);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('최고의 내용이네요!', 5, 65);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('공유해주셔서 감사해요.', 6, 66);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('좋은 정보네요. 감사합니다!', 7, 67);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('다음에도 좋은 글 부탁드립니다.', 8, 68);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('다시 읽어도 좋은 글입니다.', 9, 69);
INSERT INTO FREEBOARD_COMMENT (CONTENT, MEMBER_IDX, IDX) VALUES ('감사합니다. 많은 도움 되었어요.', 10, 70);
...
INSERT INTO TRAINER VALUES (2,13);

COMMIT;
-- 수업내용 더미데이터 작성

INSERT INTO ATTRACTION (TITLE, CONTENT, TRAINER_IDX, PROG_TIME)
VALUES ('요가', '몸과 마음의 조화를 이루는 수업입니다.', 1, TO_TIMESTAMP('2024-10-01 10:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO ATTRACTION (TITLE, CONTENT, TRAINER_IDX, PROG_TIME)
VALUES ('필라테스', '체형 교정과 근력 강화에 초점을 맞춘 수업입니다.', 1, TO_TIMESTAMP('2024-10-02 10:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO ATTRACTION (TITLE, CONTENT, TRAINER_IDX, PROG_TIME)
VALUES ('줌바', '신나는 음악에 맞춰 즐겁게 운동하는 수업입니다.', 1, TO_TIMESTAMP('2024-10-03 10:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO ATTRACTION (TITLE, CONTENT, TRAINER_IDX, PROG_TIME)
VALUES ('스피닝', '실내 자전거를 이용한 유산소 운동입니다.', 1, TO_TIMESTAMP('2024-10-04 10:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO ATTRACTION (TITLE, CONTENT, TRAINER_IDX, PROG_TIME)
VALUES ('근력 트레이닝', '체중을 이용한 근력 강화 운동입니다.', 1, TO_TIMESTAMP('2024-10-05 10:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO ATTRACTION (TITLE, CONTENT, TRAINER_IDX, PROG_TIME)
VALUES ('댄스', '다양한 장르의 댄스를 배우는 즐거운 수업입니다.', 1, TO_TIMESTAMP('2024-10-06 10:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO ATTRACTION (TITLE, CONTENT, TRAINER_IDX, PROG_TIME)
VALUES ('스트레칭', '유연성을 향상시키기 위한 스트레칭 수업입니다.', 1, TO_TIMESTAMP('2024-10-07 10:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO ATTRACTION (TITLE, CONTENT, TRAINER_IDX, PROG_TIME)
VALUES ('체육관 기초', '기초 체력 단련을 위한 종합 운동 수업입니다.', 1, TO_TIMESTAMP('2024-10-08 10:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO ATTRACTION (TITLE, CONTENT, TRAINER_IDX, PROG_TIME)
VALUES ('가벼운 조깅', '조깅을 통해 심폐 지구력을 기르는 수업입니다.', 1, TO_TIMESTAMP('2024-10-09 10:00:00', 'YYYY-MM-DD HH24:MI:SS'));
...
-- 11월 수업내용도 생성
INSERT INTO ATTRACTION (TITLE, CONTENT, TRAINER_IDX, PROG_TIME, END_TIME, PERIOD)
VALUES ('근력 강화 훈련', '전신 근력과 지구력을 기르는 집중 훈련입니다.', 2, TO_TIMESTAMP('2024-11-02 10:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2024-11-02 11:00:00', 'YYYY-MM-DD HH24:MI:SS'), 1);

INSERT INTO ATTRACTION (TITLE, CONTENT, TRAINER_IDX, PROG_TIME, END_TIME, PERIOD)
VALUES ('코어 집중 요가', '복부와 허리 코어 근육을 강화하는 요가 수업입니다.', 1, TO_TIMESTAMP('2024-11-05 11:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2024-11-05 13:00:00', 'YYYY-MM-DD HH24:MI:SS'), 2);

INSERT INTO ATTRACTION (TITLE, CONTENT, TRAINER_IDX, PROG_TIME, END_TIME, PERIOD)
VALUES ('유산소 점프 운동', '지구력을 높이고 심폐 기능을 강화하는 유산소 운동입니다.', 1, TO_TIMESTAMP('2024-11-10 12:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2024-11-10 13:00:00', 'YYYY-MM-DD HH24:MI:SS'), 1);

INSERT INTO ATTRACTION (TITLE, CONTENT, TRAINER_IDX, PROG_TIME, END_TIME, PERIOD)
VALUES ('유연성 스트레칭', '전신 유연성과 균형 감각을 기르는 스트레칭 수업입니다.', 2, TO_TIMESTAMP('2024-11-15 14:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2024-11-15 16:00:00', 'YYYY-MM-DD HH24:MI:SS'), 2);

INSERT INTO ATTRACTION (TITLE, CONTENT, TRAINER_IDX, PROG_TIME, END_TIME, PERIOD)
VALUES ('고강도 인터벌 훈련', '고강도 인터벌 방식으로 체력과 스피드를 향상시키는 수업입니다.', 1, TO_TIMESTAMP('2024-11-20 10:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2024-11-20 11:00:00', 'YYYY-MM-DD HH24:MI:SS'), 1);
