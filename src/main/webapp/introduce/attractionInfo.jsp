...
var snum = "menu_0103";
    ...
    <div class="gallery swiper-container swiper-container-initialized swiper-container-horizontal">
        <ul class="swiper-wrapper" style="transform: translate3d(-10800px, 0px, 0px); transition-duration: 0ms;"><li class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev" data-swiper-slide-index="0"><img src="./송도스포츠센터 _ 시설현황_files/gall01.jpg" alt=""></li><li class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="1"><img src="./송도스포츠센터 _ 시설현황_files/gall02.jpg" alt=""></li><li class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="2"><img src="./송도스포츠센터 _ 시설현황_files/gall03.jpg" alt=""></li><li class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3"><img src="./송도스포츠센터 _ 시설현황_files/gall04.jpg" alt=""></li><li class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="4"><img src="./송도스포츠센터 _ 시설현황_files/gall05.jpg" alt=""></li><li class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="5"><img src="./송도스포츠센터 _ 시설현황_files/gall06.jpg" alt=""></li><li class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="6"><img src="./송도스포츠센터 _ 시설현황_files/gall07.jpg" alt=""></li><li class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="7"><img src="./송도스포츠센터 _ 시설현황_files/gall08.jpg" alt=""></li>
